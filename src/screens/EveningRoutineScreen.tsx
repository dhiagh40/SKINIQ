...
  if (typeof routine === 'string' && routine.trim() !== '' && routine.trim() !== 'No routine available' && routine.trim() !== 'غير متاح') {
...
  // ✅ استلام البيانات بأمان مع قيمة افتراضية
  const routine = route.params?.routine || [];
  const routineSteps = processRoutine(routine);
